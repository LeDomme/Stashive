...
test('generic inventory workflow supports duplicate copies and location states', async ({ page }) => {
  ...
  await page.getByLabel('Edition').selectOption({ label: 'Other / Custom' })
  await page.getByLabel('Other / Custom Edition').fill('T06 Browser Edition')
  ...
  await page.getByLabel('Other / Custom Condition').fill('Very good')
