...
export interface Edition { id:number; catalog_entry_id:number; display_name:string; media_format:string|null; release_date:string|null; publisher:string|null; regions:string[]; languages:string[] }
...
export type EditionPayload = Partial<Pick<Edition, 'display_name'|'media_format'|'release_date'|'publisher'|'regions'|'languages'>>
