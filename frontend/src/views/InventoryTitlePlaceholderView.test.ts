...
const router = createRouter({ history: createMemoryHistory(), routes: [
  ...
  { path: '/collections/:collectionId/inventory/:catalogEntryId/editions/:editionId/copies/new', name: 'inventory-copy-new', component: InventoryTitlePlaceholderView },
...
describe('InventoryTitlePlaceholderView', () => {
  ...
  it('shows title and edition management entry points only to content editors', async () => {
    ...
    expect(editor.text()).toContain('Add physical copy')
    ...
    expect(viewer.text()).not.toContain('Add physical copy')
